#!/bin/bash
# Custom configuration (3) by sevcator

# Zapret Configuration
# <-- -->

# list.txt
config="--filter-tcp=80 --hostlist=$MODPATH/list/list.txt --dpi-desync=fakeddisorder --dpi-desync-ttl=3 --dpi-desync-split-pos=midsld --new"
...
# list-auto.txt
config="$config --filter-tcp=80 --hostlist-auto=$MODPATH/list/list-auto.txt --hostlist-exclude=$MODPATH/list/list-exclude.txt --dpi-desync=fakeddisorder --dpi-desync-ttl=3 --dpi-desync-split-pos=midsld --new"
...
# ipset.txt
config="$config --filter-tcp=80 --ipset=$MODPATH/ipset/ipset.txt --dpi-desync=fakeddisorder --dpi-desync-ttl=3 --dpi-desync-split-pos=midsld --new"
