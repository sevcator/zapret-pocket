...
# Default list
config="--filter-tcp=80 --hostlist=$MODPATH/list/default.txt --dpi-desync=fake,multisplit --dpi-desync-split-pos=sld+1 --dpi-desync-fooling=md5sig --dpi-desync-autottl --new"
...
config="$config --filter-tcp=443 --hostlist=$MODPATH/list/reestr_hostname.txt --hostlist-exclude=$MODPATH/list/default.txt --dpi-desync=split2 --dpi-desync-repeats=2 --dpi-desync-split-seqovl=681 --dpi-desync-split-pos=1 --dpi-desync-fooling=badseq,hopbyhop2 --dpi-desync-split-seqovl-pattern=$MODPATH/fake/tls_clienthello_www_google_com.bin --new"
...
config="$config --filter-tcp=443 --ipset=$MODPATH/ipset/ipset-all.txt --hostlist=$MODPATH/list/providers.txt --dpi-desync=split2 --dpi-desync-repeats=2 --dpi-desync-split-seqovl=681 --dpi-desync-split-pos=1 --dpi-desync-fooling=badseq,hopbyhop2 --dpi-desync-split-seqovl-pattern=$MODPATH/fake/tls_clienthello_www_google_com.bin --new"
