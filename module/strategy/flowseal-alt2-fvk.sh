...
config="$config --filter-tcp=443 --hostlist-auto=$MODPATH/list/list-auto.txt --hostlist-exclude=$MODPATH/list/list-exclude.txt --dpi-desync=split2 --dpi-desync-split-seqovl=652 --dpi-desync-split-pos=2 --dpi-desync-split-seqovl-pattern=$MODPATH/fake/tls_clienthello_vk_com.bin --new"
...
config="$config --filter-tcp=443 --ipset=$MODPATH/ipset/ipset.txt --dpi-desync=split2 --dpi-desync-split-seqovl=652 --dpi-desync-split-pos=2 --dpi-desync-split-seqovl-pattern=$MODPATH/fake/tls_clienthello_vk_com.bin --new"
...
# Discord RTC
config="$config --filter-udp=50000-50100 --filter-l7=discord --dpi-desync=fake --dpi-desync-cutoff=n2 --dpi-desync-ttl=4 --dpi-desync-fake-quic=$MODPATH/fake/quic_initial_vk_com.bin"
