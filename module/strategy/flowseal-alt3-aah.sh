...
config="$config --filter-tcp=443 --hostlist=$MODPATH/list/list-cloudflare.txt --dpi-desync=split --dpi-desync-split-pos=1 --dpi-desync-autottl --dpi-desync-fooling=badseq --dpi-desync-repeats=8 --new"
...
config="$config --filter-tcp=443 --ipset=$MODPATH/ipset/ipset-cloudflare.txt --dpi-desync=split --dpi-desync-split-pos=1 --dpi-desync-autottl --dpi-desync-fooling=badseq --dpi-desync-repeats=8 --new"
