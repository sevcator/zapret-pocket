...
config="$config --filter-tcp=443 --hostlist=$MODPATH/list.txt --dpi-desync=split --dpi-desync-split-pos=1 --dpi-desync-autottl --dpi-desync-fooling=badseq --dpi-desync-repeats=8 --new"
