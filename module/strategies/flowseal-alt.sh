...
config="$config --filter-tcp=443 --hostlist=$MODPATH/list.txt --dpi-desync=fake,split --dpi-desync-autottl=2 --dpi-desync-repeats=6 --dpi-desync-fooling=badseq --dpi-desync-fake-tls=$MODPATH/tls_clienthello_www_google_com.bin --new"
...
config="$config --filter-tcp=443 --ipset=$MODPATH/ipset-host.txt --dpi-desync=fake --dpi-desync-autottl=2 --dpi-desync-repeats=6 --dpi-desync-fooling=badseq --dpi-desync-fake-tls=$MODPATH/tls_clienthello_www_google_com.bin --new"
config="$config --filter-tcp=443 --hostlist-auto=$MODPATH/list-auto.txt --dpi-desync=fake --dpi-desync-repeats=6 --dpi-desync-fooling=badseq --dpi-desync-fake-tls=$MODPATH/tls_clienthello_www_google_com.bin"