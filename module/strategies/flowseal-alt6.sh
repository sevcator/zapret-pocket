...
config="$config --filter-l3=ipv4 --filter-tcp=443 --dpi-desync=syndata --new"
...
config="$config --filter-tcp=80 --hostlist-auto=$MODPATH/list-auto.txt --dpi-desync=fake,split2 --dpi-desync-autottl=2 --dpi-desync-fooling=md5sig"