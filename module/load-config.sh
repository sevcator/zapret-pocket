...
config="$config --filter-udp=80 --dpi-desync=fake --dpi-desync-repeats=11 $hostlist --dpi-desync-fake-quic=$MODPATH/quic.bin --new"
config="$config --filter-udp=443 --dpi-desync=fake --dpi-desync-repeats=11 $hostlist --dpi-desync-fake-quic=$MODPATH/quic.bin --new"
