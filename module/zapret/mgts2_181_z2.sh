...
# mgts2_181_z2.sh
# source-profile: mgts2_181 (translated zapret1 -> zapret2 / nfqws2)
...
if [ "$(cat "$MODPATH/config/bypass-calls" 2>/dev/null || echo 0)" = "1" ]; then
    config="$config --filter-tcp=2053,2083,2087,2096,8443 --hostlist-domains=discord.media --payload=tls_client_hello --lua-desync=fake:blob=fake_tls_google:repeats=6:tcp_md5 --new"
