...
# Author: RomanKozyrev
# Strategy: TTK with fakeddisorder
...
config="$config --filter-tcp=443 --hostlist=$MODPATH/list/list-google.txt --dpi-desync=fakeddisorder --dpi-desync-repeats=16 --dpi-desync-fooling=md5sig --new"
