...
# multisplitmd5sigpadencap.sh
# source-profile: multisplitmd5sigpadencap
...
config="$config --filter-tcp=443 --hostlist=$MODPATH/list/list-google.txt --dpi-desync=fake,multisplit --dpi-desync-split-seqovl=1 --dpi-desync-split-pos=1 --dpi-desync-fake-tls=$MODPATH/zapret/tls_clienthello_vk_com.bin --dpi-desync-ttl=5 --new"
