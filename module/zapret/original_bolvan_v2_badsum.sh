...
# original_bolvan_v2_badsum.sh
# source-profile: original_bolvan_v2_badsum
...
config="$config --filter-tcp=443 --hostlist=$MODPATH/list/list-google.txt --dpi-desync=multisplit --dpi-desync-fooling=datanoack --new"
